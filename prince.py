    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 5:
            ...
            try:
                ...
                await event.edit("Succesfully Changed Bio By PRINCE MULTI SPAM BOT")
            except Exception as e:
...
ALIVE_PIC = "https://telegra.ph/file/1e88f6f58c390a713f33f.jpg"
import os
prince = os.environ.get("ALIVE_PIC",None)
if not prince:
 prince="https://telegra.ph/file/1e88f6f58c390a713f33f.jpg"
